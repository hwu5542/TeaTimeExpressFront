...
const ShoppingPage: React.FC<unknown> = (props) => {
  return (
    <div>
      <div className="container px-4 py-5" id="custom-cards">
        ...
        <div className="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
          <div className="col">
            <div className="card card-cover h-100 overflow-hidden text-white bg-dark rounded-5 shadow-lg" style={{ backgroundImage: `url(${teaImage})`}}>
